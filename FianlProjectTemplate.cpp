//***************************************************************************
// FinalProjectTemplate.cpp 
// Programers  ChristopherLarent-Carlson ID: 101091856   
//  
// 
//
// 01_Lights.
// 
// Assets used come from opengameart.org and unreal free assets 
//
// Description:
...
// Texture variables.
GLuint blankID ,FloorID ,GrassID;
...
void init(void)
{
	...
	Projection = glm::perspective(glm::radians(45.0f), 1.0f / 1.0f, 0.1f, 500.0f);
	...
	image2 = stbi_load("medieval_blocks_06_diff_1k.jpg", &width, &height, &bitDepth, 0);
	image3= stbi_load("GrassTexture.png", &width, &height, &bitDepth, 0);

	if (!image) { cout << "Unable to load file!" << endl; }
	
	glGenTextures(0, &blankID);
...
void display(void)
{
	...
	glBindTexture(GL_TEXTURE_2D, FloorID); // Use this texture for all shapes.
